...
public enum ModArmorMaterial implements IArmorMaterial {
    MUSHROOM_MUSH("mushroom_mush",7,new int[] { 2, 5, 6, 2},12, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER,1.0f,1.0f,() -> {
        return Ingredient.fromItems(ModItems.MUSHROOM_MUSH.get());
    });
    ...
    public String getName() {
        return DegradeMod.MOD_ID + ":" + this.name;
    }
